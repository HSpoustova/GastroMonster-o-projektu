    ...
    <>
      <div className="main__container">
          <div className="main__content">
            ...
            <p>
              Hra různé prvky hry, jako je náhodné generování otázek, obměny
              nových otázek po špatných odpovědích, pohyb malého avatara na
              herním poli, komunikaci monstra během hry či poskytování nápověd.
            </p>
          </div>
        </div>
